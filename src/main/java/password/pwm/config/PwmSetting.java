...
// --------------------- GETTER / SETTER METHODS ---------------------
    ...
    public static Map<Category, List<PwmSetting>> valuesByFilter(final Template template, final Category.Type categoryType, final int level) {
        ...
        final Map<Category, List<PwmSetting>> returnMap = new TreeMap<Category, List<PwmSetting>>();
