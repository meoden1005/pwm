...
public class ProcessChaResRequest  implements java.io.Serializable {
     ...
     * @param chaAnswers
     */
    public void setChaAnswers(String[] chaAnswers) {
        this.chaAnswers = chaAnswers;
    }

    public String getChaAnswers(int i) {
        return this.chaAnswers[i];
    }

    public void setChaAnswers(int i, String _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getChaAnswers() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getChaAnswers(), i);
                if (obj != null &&
