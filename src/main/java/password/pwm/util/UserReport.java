...
public class UserReport {
    ...
    public void outputToCsv(final OutputStream outputStream, final boolean includeHeader, final int maxResults)
        ...
        for (final Iterator<UserInformation> resultIterator = this.resultIterator(maxResults); resultIterator.hasNext(); ) {
            final UserInformation userInformation = resultIterator.next();
