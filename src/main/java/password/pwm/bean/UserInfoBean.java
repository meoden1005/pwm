 ...
 * @see password.pwm.util.operations.UserStatusHelper#populateUserInfoBean(password.pwm.PwmSession, UserInfoBean, password.pwm.PwmApplication, Locale, String, String, com.novell.ldapchai.provider.ChaiProvider)
 */
